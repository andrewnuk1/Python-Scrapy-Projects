...
if __name__ == '__main__':
    ...
    select_tweets_since = datetime.datetime.strptime("2016-12-01", '%Y-%m-%d')
    select_tweets_until = datetime.datetime.strptime("2017-01-01", '%Y-%m-%d')
...
# excel
wb.save('deliverootwitter20161231.csv')
